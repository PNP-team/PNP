...
class FBSMGate:
    ...
    def quotient_term(
        ...
        x_3_times_xy_alpha_times_acc_x_times_acc_y_times_coeff_d = F.mul_mod_scalar(
            x_3_times_xy_alpha_times_acc_x_times_acc_y, P.COEFF_D().to("cuda")
        )
        lhs_x = F.add_mod(x_3, x_3_times_xy_alpha_times_acc_x_times_acc_y_times_coeff_d)
        x_3_times_acc_y = F.mul_mod(x_alpha, acc_y)
        y_alpha_times_acc_x = F.mul_mod(y_alpha, acc_x)
        ...
        y_3_times_xy_alpha_times_acc_x_times_acc_y_times_coeff_d = F.mul_mod_scalar(
            y_3_times_xy_alpha_times_acc_x_times_acc_y, P.COEFF_D().to("cuda")
        )
        lhs_y = F.sub_mod(y_3, y_3_times_xy_alpha_times_acc_x_times_acc_y_times_coeff_d)
        y_alpha_times_acc_y = F.mul_mod(y_alpha, acc_y)
